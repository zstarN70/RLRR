...
def get_args_parser():
    ...
    parser.add_argument("--model_type", default="ViT-H_14")
    parser.add_argument("--dataset_dir", default="/home/Datasets/VTAB-1K/vtab-1k")
    parser.add_argument("--pretrained_dir", type=str, default="./checkpoint/ViT-H_14.npz")  #imagenet21k_
    parser.add_argument("--output_dir", default="output/vtab_vit-H-rerun-no-aug-A800", type=str)  #-no-aug-line-
...
def main(args):
    ...
    train_loader, test_loader = get_data(data_path=args.data_path, batch_size=args.batch_size, simple_aug=args.simple_aug)
